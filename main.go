...
func main() {
	...
	json, err := json.Marshal(Person{UserRef: "KFG-734", Name: "Kerem", DOB: "18.06.1985", PhoneNumber: "+901111111111", Address: "Woodbine Close TW2 something"})
	if err != nil {
		fmt.Println(err)
	}
	...
	Persons = []Person{
		Person{UserRef: "KFG-734", Name: "Kerem", DOB: "18.06.1985", PhoneNumber: "+441111111111", Address: "Woodbine Close TW2"},
		Person{UserRef: "XRT-251", Name: "John", DOB: "11.11.1111", PhoneNumber: "+442222222222", Address: "Somewhere in London"},
	}
